...
//
// Measured 2026-09-16 against production:
//   select count(*) from media
//   where sensitive is not true and suggestive is not true;
// Re-measure and bump when the catalog grows materially. The previous figure
// was measured 2026-08-31 at 76,264 and was 16,558 short by the time anyone
// looked at the rendered page, which is how "more than 76,000" ended up
// printed under a catalog of 92,822.
export const CATALOG_COUNT = 92822;
export const CATALOG_COUNT_LABEL = CATALOG_COUNT.toLocaleString("en-US");

// Static copy quotes the floored form ("more than 92,000"): the homepage grid

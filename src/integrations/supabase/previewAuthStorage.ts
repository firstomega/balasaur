...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      // const, not let: finish() closes over this, and the only paths that call
      // finish (a message event or this timeout) can fire only after the
      // synchronous body has run, so it is always initialised by then.

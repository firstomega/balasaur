    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-[720px] px-5 py-12">
        ...
        <article className="space-y-8 text-[15px] leading-relaxed text-foreground">
          <p>
            Balasaur ("Balasaur," "we," "us") operates balasaur.com (the "Service"). This Privacy
          ...
          <Section title="1. Information we collect">
            <ul className="list-disc space-y-2 pl-5 marker:text-text-dim">
              <li>
                Account information: your email address and authentication credentials (managed by
                our authentication provider) when you create an account.
              </li>
              <li>
                Activity and preferences: media you mark as seen, want, liked, or disliked; lists
                you create; and your filters and settings. This is how the Service personalizes your
                experience.
              </li>
              <li>
          ...
          <Section title="2. How we use your information">
            <p>
              To provide and personalize the Service; to create and secure your account; to analyze
              and improve the Service; to communicate with you about your account; and to comply
          ...
          <Section title="3. Third-party data and services">
            <ul className="list-disc space-y-2 pl-5 marker:text-text-dim">
              <li>
                Content data (titles, ratings, availability) is provided by third parties including
                TMDB, OMDb (which aggregates ratings from sources such as IMDb, Rotten Tomatoes, and
                Metacritic), and JustWatch (streaming availability). We do not control and are not
                responsible for the accuracy of third-party data.
              </li>
              <li>
          ...
          <Section title="6. Data retention">
            <p>
              We keep your account information while your account is active. You can delete your
              account at any time, after which we delete or anonymize your personal data except
          ...
          <Section title="8. International users">
            <p>
              The Service is operated from the United States and may be accessed globally. By using
              it, you understand your information may be processed in the United States and other
              countries.
            </p>
          </Section>
